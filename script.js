...
if(snakeBody[0].classList.contains('snakeBody')){
  setTimeout(()=> {
    alert(`GAME OVER :( Mouse collected ${score}`);
  },1000);
  
  clearInterval(interval);
  // snakeBody[0].style.background = 'url(scream.png) center no-repeat';
  // snakeBody[0].style.backgroundSize = "cover";
  // snakeBody[0].style.backgroundSize = "90%";
  field.style.background = 'url(cat-galaxy.gif) center no-repeat';
